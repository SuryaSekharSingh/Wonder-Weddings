...
<div class="gallery">
	<div class="gallery__column">
		...
		<a href="https://unsplash.com/@oladimeg" target="_blank" class="gallery__link">
			<figure class="gallery__thumb">
				<img src="images/gallery/port-img-1.jpg" alt="Portrait by Oladimeji Odunsi" class="gallery__image">
	...
	<div class="gallery__column">
		<a href="https://unsplash.com/@noahbuscher" target="_blank" class="gallery__link">
			<figure class="gallery__thumb">
				<img src="images/gallery/port-img-2.jpg" alt="Portrait by Noah Buscher" class="gallery__image">
